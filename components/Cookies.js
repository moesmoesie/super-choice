    ...
    <AnimatePresence>
      {!hasCookies && (
        <motion.div className="h-screen pointer-events-none w-full absolute">
          <motion.div
            className="py-6 px-4 z-[200] pointer-events-auto w-full bg-primary5 absolute bottom-0 grid place-items-center"
          ...
          >
            <div className="flex items-center flex-col gap-3 md:flex-row">
              ...
              <button
                className="px-5 rounded-md py-1 bg-white text-primary5"
