            ...
            <button
                ...
                <div className='flex gap-x-2 items-center'>
                    <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.0625 1L1 5.0625L5.0625 9.125" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M1 5.0625H7.5C11.9874 5.0625 15.625 8.70006 15.625 13.1875V14" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
