...
export default function NavigationItem({ item, className }) {
    return (
        <motion.a href={item.slug} className={`${className} pointer-events-auto cursor-pointer grid place-items-center relative overflow-hidden`}
